...
class project_data(_BaseDataset):
    """Dataset class for project dataset bounding box tracking"""
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join(code_path, 'data/gt/project/'),  # Location of GT data
            'TRACKERS_FOLDER': os.path.join(code_path, 'data/trackers/project/'),  # Trackers location
            'OUTPUT_FOLDER': None,  # Where to save eval results (if None, same as TRACKERS_FOLDER)
            'TRACKERS_TO_EVAL': None,  # Filenames of trackers to eval (if None, all in folder)
            'CLASSES_TO_EVAL': ['grasper', 'bipolar', 'hook', 'scissors', 'clipper',
                                       'irrigator', 'specimenbag'],  # Valid: ['pedestrian']
            'BENCHMARK': 'project',  # Valid: 'MOT17', 'MOT16', 'MOT20', 'MOT15'
    ...
    def __init__(self, config=None):
        ...
        # Get classes to eval
        self.valid_classes = ['grasper', 'bipolar', 'hook', 'scissors', 'clipper',
        ...
        self.class_name_to_class_id = {'grasper': 1, 'bipolar': 2, 'hook': 3, 'scissors': 4, 'clipper': 5,
                                       'irrigator': 6, 'specimenbag': 7}
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        distractor_class_names = ['grasper', 'bipolar', 'hook', 'scissors', 'clipper',
                                       'irrigator', 'specimenbag']
